...
base_dir_save = conf['RDA']['save_loc'] + 'cloud/' 
...
for i_var, var in enumerate(conf['RDA']['varname_cloud_process']):
...
# upper-air var names
varnames = list(conf['RDA']['varname_cloud_process'].values())
...
# save
save_name = base_dir_save + conf['RDA']['prefix'] + '_cloud_{}.zarr'.format(year)
