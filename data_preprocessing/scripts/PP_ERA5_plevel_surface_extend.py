'''
This script is the same as PP_ERA5_plevel_surface.py but with extended variables
that were missing form the previous runs
...
# save
save_name = base_dir_save + conf['RDA']['prefix'] + '_surf_extend_{}.zarr'.format(year)
